...
/*ployment environment can be anything like Docker, kubernetes or cloud.
/*eate 'deploy.properties' file at same location and save all the build and deployment properties. This file will be refered by this pipeline for build and deployment. */
/*f workspace;
/*f props='';
/*f tagName="""${JOB_NAME}-${BUILD_TIMESTAMP}"""
/*f branchName;
/*f commit_username;
/*f commit_Email;
/*f appDeployProcess;
...
/*
/*f notifyBuild(String buildStatus, String buildFailedAt, String bodyDetails, String commit_Email) 
/*
...
/*
/*f logJIRATicket(String buildStatus, String buildFailedAt, String projectid, String issuetype, String assignTo, String issueReporter) 
/*
/*buildStatus = buildStatus ?: 'SUCCESS'
...
/*}
/*
/*f staticCodeAnalysis(String scannerHome, String sonarHosturl)
/*
/*sh """	
/*${scannerHome}/bin/sonar-runner -D sonar.host.url=${sonarHosturl} -D sonar.login=admin -D sonar.password=admin"""
/*
/*f codeCoverage(String scannerHome, String sonarHosturl)
/*
/*sh """	
